...
function HotelDetail(props: props) {
  ...
  return (
    <HotelDetailContainer onClick={handleRoute}>
      <HotelImage src={'http://www.jjtravelonline.com/images/inner-services/hotel-inner.png'} />
      <HotelInfo>
        <Availability>Entire Apartment</Availability>
        <Title>{props.title}</Title>
        <Popularity>
          <img src={'https://image.flaticon.com/icons/png/512/906/906338.png'} alt="feed"></img>
          <p><span>RARE FIND</span> This place is usually booked.</p>
        </Popularity>
        <RoomsDescription>2 guests * 1 bedroom * 3 Beds * 1 Bath</RoomsDescription>
